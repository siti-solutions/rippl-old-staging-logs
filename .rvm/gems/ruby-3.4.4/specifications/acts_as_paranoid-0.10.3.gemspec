# -*- encoding: utf-8 -*-
# stub: acts_as_paranoid 0.10.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/ActsAsParanoid/acts_as_paranoid/blob/master/CHANGELOG.md", "rubygems_mfa_required" => "true" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 6.1".freeze, "< 8.1".freeze])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 6.1".freeze, "< 8.1".freeze])
