...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/travis/.rvm/rubies/ruby-3.4.4")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/travis/.rvm/rubies/ruby-3.4.4' '--enable-yjit' '--without-tcl' '--without-tk' '--without-gmp' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
