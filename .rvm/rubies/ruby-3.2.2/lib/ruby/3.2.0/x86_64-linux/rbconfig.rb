...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/travis/.rvm/rubies/ruby-3.2.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/travis/.rvm/rubies/ruby-3.2.2' '--enable-yjit' '--without-tcl' '--without-tk' '--without-gmp' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["MJIT_CC"] = "/usr/lib/ccache/gcc"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
